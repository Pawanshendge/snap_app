# -*- encoding: utf-8 -*-
# stub: bx_block_shopping_cart-9ec30a1c 0.0.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<bx_block_calendar-4836ef12>.freeze, [">= 0"])
      s.add_runtime_dependency(%q<bx_block_address-07f1bf4f>.freeze, [">= 0"])
      s.add_runtime_dependency(%q<bx_block_coupons-94a34a84>.freeze, [">= 0"])
      ...
      s.add_dependency(%q<bx_block_calendar-4836ef12>.freeze, [">= 0"])
      s.add_dependency(%q<bx_block_address-07f1bf4f>.freeze, [">= 0"])
      s.add_dependency(%q<bx_block_coupons-94a34a84>.freeze, [">= 0"])
