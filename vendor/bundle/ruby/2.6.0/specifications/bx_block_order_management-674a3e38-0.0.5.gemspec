# -*- encoding: utf-8 -*-
# stub: bx_block_order_management-674a3e38 0.0.5 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<bx_block_fedex_integration-c7604a00>.freeze, ["= 0.0.2"])
      ...
      s.add_dependency(%q<bx_block_fedex_integration-c7604a00>.freeze, ["= 0.0.2"])
