# -*- encoding: utf-8 -*-
# stub: bx_block_coupons-94a34a84 0.0.5 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_coupons-94a34a84".freeze
  s.version = "0.0.5"
  ...
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_coupons".freeze
  s.rubygems_version = "3.0.3".freeze
  s.summary = "BxBlockCoupons".freeze
