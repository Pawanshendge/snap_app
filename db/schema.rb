...
ActiveRecord::Schema.define(version: 2023_12_02_140909) do
  ...
  create_table "additional_price_per_pages", force: :cascade do |t|
  ...
  create_table "addresses", force: :cascade do |t|
    ...
    t.string "landmark"
    t.string "state"
    t.boolean "share_with_family_member", default: false
    t.integer "order_id"
  ...
  create_table "album_sizes", force: :cascade do |t|
    t.integer "min_limit"
    t.integer "max_limit"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "book_colors", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.text "book_color"
    t.text "logo_color"
  ...
  create_table "book_sizes", force: :cascade do |t|
    t.string "book_size"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
  ...
  create_table "bx_block_custom_user_subs_subscriptions", force: :cascade do |t|
    ...
    t.date "valid_up_to"
    t.text "details"
    t.decimal "book_original_price"
    t.integer "no_of_books"
    t.string "gift_included"
    t.decimal "total_amount"
    t.decimal "subscription_package_amount"
    t.boolean "active", default: false
  end

  create_table "bx_block_stories_blogs", force: :cascade do |t|
    t.string "title"
    t.text "description"
    t.integer "status"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "bx_block_stories_stories", force: :cascade do |t|
    t.text "description"
  ...
  create_table "custom_emails", force: :cascade do |t|
    ...
    t.string "phone_no"
    t.string "email"
    t.string "timing_of_service"
    t.integer "valid_for"
  end

  create_table "dashboard_media_files", force: :cascade do |t|
    t.string "name"
    t.integer "priority"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "draft_mail_timers", force: :cascade do |t|
  ...
  create_table "image_limits", force: :cascade do |t|
  ...
  create_table "invite_users", force: :cascade do |t|
    ...
    t.string "unique_identify_id"
    t.bigint "account_id"
    t.bigint "table_books_id"
    t.index ["account_id"], name: "index_invite_users_on_account_id"
    t.index ["table_books_id"], name: "index_invite_users_on_table_books_id"
  end
  ...
  create_table "offers", force: :cascade do |t|
    ...
    t.bigint "phone_number"
    t.string "email"
    t.integer "max_capping_limit"
    t.integer "combine_with_other_offer"
    t.decimal "extra_discount"
    t.string "full_phone_number"
  end
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.integer "order_child_id"
    t.string "title_layout"
    t.string "payment_status"
    t.string "book_url"
    t.integer "additional_pages"
    t.decimal "base_price"
    t.decimal "additional_price"
    t.string "sharable_code"
    t.string "used_discount_code"
  ...
  create_table "referral_limit_settings", force: :cascade do |t|
  ...
  create_table "referral_user", force: :cascade do |t|
  ...
  create_table "rnr_policy", force: :cascade do |t|
    t.text "content"
  end
  ...
  create_table "shared_addresses", force: :cascade do |t|
    t.string "phone_number"
    t.string "full_name"
    t.string "pincode"
    t.string "city"
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.string "address1"
    t.index ["address_id"], name: "index_shared_addresses_on_address_id"
  end
  ...
  create_table "table_books", force: :cascade do |t|
    t.string "year"
    t.string "month"
  ...
  create_table "tnc", force: :cascade do |t|
    t.text "content"
  end
  ...
  add_foreign_key "invite_users", "accounts"
  add_foreign_key "invite_users", "table_books", column: "table_books_id"
  ...
  add_foreign_key "shared_addresses", "addresses"
